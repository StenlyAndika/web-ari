...
@section('container')
    <div class="bg-white w-full rounded-lg shadow-sm border border-gray-200">
        ...
        <form method="GET" action="{{ route('admin.laporan.masuk') }}" class="px-6">
            ...
            <div class="flex space-x-1">
                ...
                <a href="{{ route('admin.laporan.masuk.print', ['bln' => $bln]) }}"
                    class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center mt-2 mb-4">
                    Cetak Laporan
                </a>
            </div>
        ...
        <h1 class="text-xl font-semibold text-gray-700 px-6 text-center">Laporan Barang Masuk</h1>
            ...
            <table class="min-w-full text-sm text-left text-gray-700">
                <thead class="bg-gray-100 text-xs uppercase text-gray-600">
                    <tr>
                        ...
                        <th class="px-6 py-4">Harga Barang</th>
                ...
                <tbody>
                    @foreach ($barangmasuk as $item)
                        <tr>
                            ...
                            <td class="px-6 py-3">Rp.{{ number_format($item->jumlah*$item->harga, 0, ',', '.') }}</td>
