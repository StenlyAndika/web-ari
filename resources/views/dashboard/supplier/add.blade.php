<!-- Modal Toggle -->
<div x-data="{ tambah_supplier: false }">
    <!-- Open Button -->
    <button @click="tambah_supplier = true" class="px-4 py-2 text-white bg-emerald-500 text-sm font-bold rounded hover:bg-blue-700">
        Data Baru
    </button>

    <!-- Modal Backdrop -->
    <div
        x-show="tambah_supplier"
        x-transition.opacity
        class="fixed inset-0 bg-black bg-opacity-50 z-40"
        @click="tambah_supplier = false"
    ></div>
    ...
    >
        <div
            @click.away="tambah_supplier = false"
        ...
        >
            ...
            <form method="post" action="{{ route('admin.supplier.store') }}" autocomplete="off" class="space-y-2 px-6">
                @csrf
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="button" @click="tambah_supplier = false"
