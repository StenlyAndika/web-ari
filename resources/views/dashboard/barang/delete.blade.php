<!-- Modal Toggle -->
<div x-data="{ hapus_barang: false }">
    <!-- Open Button -->
    <button @click="hapus_barang = true" class="px-4 py-2 text-white bg-red-600 text-sm font-bold rounded hover:bg-red-700">
        Hapus
    </button>
        ...
        >
            ...
            <form method="post" action="{{ route('admin.barang.destroy', $item->id) }}" autocomplete="off" class="space-y-2 px-6">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="button" @click="hapus_barang = false"
