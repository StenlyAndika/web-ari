<!-- Modal Toggle -->
<div x-data="{ modal_barang: false }">
    <!-- Open Button -->
    <button @click="modal_barang = true" class="px-4 py-2 text-white bg-primary text-sm font-bold rounded hover:bg-blue-700">
        Data Baru
    </button>
        ...
        >
            ...
            <form method="post" action="{{ route('admin.barang.store') }}" autocomplete="off" class="space-y-2">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="button" @click="modal_barang = false"
