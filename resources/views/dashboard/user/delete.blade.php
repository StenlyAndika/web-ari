<!-- Modal Toggle -->
<div x-data="{ hapus_user: false }">
    <!-- Open Button -->
    <button @click="hapus_user = true" class="px-4 py-2 text-white bg-red-600 text-sm font-bold rounded hover:bg-red-700">
        Hapus
    </button>
    ...
    >
        ...
        >
            <h2 class="text-xl font-semibold mb-4 w-full border-l-4 border-emerald-500 pl-4 pr-4 py-2 bg-gray-100">Hapus Data User</h2>
            <form method="post" action="{{ route('admin.user.destroy', $item->id) }}" autocomplete="off" class="space-y-2 px-6">
                @csrf
                @method('delete')
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="button" @click="hapus_user = false"
