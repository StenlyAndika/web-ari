<!-- Modal Toggle -->
<div x-data="{ tambah_user: false }">
    <!-- Open Button -->
    <button @click="tambah_user = true" class="px-4 py-2 text-white bg-emerald-500 text-sm font-bold rounded hover:bg-blue-700">
        Data Baru
    </button>
    ...
    >
        ...
        >
            ...
            <form method="post" action="{{ route('admin.user.store') }}" autocomplete="off" class="space-y-2 px-6">
                @csrf
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="button" @click="tambah_user = false"
